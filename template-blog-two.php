...
<section class="singleblog wrapper cf">
    ...
    <div id="post" class="blogpostsgrid twocolpag content <?php if(ale_get_meta('sidebarblog')=='hideside') { echo "fullwidth"; } elseif(ale_get_meta('sidebarblog')=='leftside'){ echo "leftsidebaron"; } elseif(ale_get_meta('sidebarblog')=='rightside') { echo "rightsidebaron"; } ?>">
