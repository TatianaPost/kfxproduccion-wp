...
if ( function_exists('register_sidebar') ) {
        ...
        register_sidebar(array(
            'name' => 'Left Custom Pages Sidebar',
            'id' => 'left-custompag-sidebar',
            'description' => 'Appears as the left sidebar on Blog pages',
            'before_widget' => '<li id="%1$s" class="widget %2$s">',
            'after_widget' => '</li>',
            'before_title' => '<div class="widtitle"><h4 class="widgettitle">',
        ...
        register_sidebar(array(
            'name' => 'Right Custom Pages Sidebar',
            'id' => 'right-custompag-sidebar',
            'description' => 'Appears as the right sidebar on Blog pages',
            'before_widget' => '<li id="%1$s" class="widget %2$s">',
            'after_widget' => '</li>',
            'before_title' => '<div class="widtitle"><h4 class="widgettitle">',
...
function pbd_alp_init() {
    ...
    if(is_page_template('template-blog-two.php') or is_page_template('template-blog-three.php') or is_page_template('template-blog-four.php')) {
